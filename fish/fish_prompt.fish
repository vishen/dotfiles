...
function fish_prompt
  ...
  # Kubeconfig and ip address
  #printf "["
  #printf "%s" (set_color blue)(hostname -I | awk '{print $2}')(set_color normal)
  #printf "| %s" (set_color blue)(kubectl config current-context)(set_color normal)
  #printf "] "
  ...
  echo
  if test -e "go.mod"
    printf "[go:%s] " (set_color blue)(go version | awk '{print $3}')(set_color normal)
  end
  
  # This works, but terraform version is so slow... Like, wtf.
  #if test -e ".terraform"
	#printf "[terraform:%s] " (set_color blue)(terraform version | head -n 1 | awk '{print $2}')(set_color normal)
  #end
  
  if test -e "Cargo.toml"
	printf "[rust:%s] " (set_color blue)(rustc --version | awk '{print $2}')(set_color normal)
  end
